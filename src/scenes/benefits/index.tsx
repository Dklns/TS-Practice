  ...
  return (
    <section id="benefits" className="mx-auto min-h-full w-5/6 py-20">
        <motion.div onViewportEnter={() => setSelectedPage(SelectedPage.Benefits)}>
            ...
            {/* benefits */}
            <motion.div 
              className="flex items-center justify-between gap-8 mt-5"
              initial="hidden"
              whileInView="visible"
            ...
            >
                {benefits.map((benefit:BenefitType) => (
                    <Benefit key={benefit.title} title={benefit.title} icon={benefit.icon} description={benefit.description}
